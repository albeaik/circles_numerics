...
[Q0_7.dbp1, Q0_7.dbe1] = get_rectangler_discontinuity_boundary( [0,12], [10,13], [0.1,0.5] ); 
[Q0_7.dbp2, Q0_7.dbe2] = get_rectangler_discontinuity_boundary( [10,5], [20,7], [0.1,0.5] );
...
[Q0_8.dbp1, Q0_8.dbe1] = get_rectangler_discontinuity_boundary( [0,12], [10,13], [0.1,0.5] ); 
Q0_8.oracle = @(x,v) (x>=0).*(x<=10).*(v>=12).*(v<=13);
Q0_8.discontinuity_boundary_points = [Q0_7.dbp1];
Q0_8.discontinuity_boundary_edges = [Q0_7.dbe1];